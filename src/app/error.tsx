    ...
    >
      <Card className="flex flex-col gap-4 p-6">
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          <Link
            href="/"
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl font-display text-base font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 sm:w-auto border border-input bg-background h-11 px-4"
          >
            {es.backToHome}
          </Link>
        </div>
